...
export async function checkDurableObjectExists(inventory: DurableObjectStub<MyDurableObject>, key: string, objectId: DurableObjectId): Promise<boolean> {
  return inventory.contains(key, objectId.toString());
}
